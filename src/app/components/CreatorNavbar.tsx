...
const navLinks = [
  { label: "Browse Campaigns", path: "/creator/campaigns" },
  { label: "My Submissions", path: "/creator/submissions" },
  ...
  return (
    ...
    >
      <div className="w-full max-w-[1280px] mx-auto px-8 relative flex items-center justify-between h-16">
        {/* Left: Logo */}
        <Link to="/creator/dashboard" className="flex items-center no-underline shrink-0">
        ...
        <div className="hidden md:flex items-center gap-3 shrink-0">
          <div className="relative">
            ...
            <NotificationDropdown open={notifOpen} onClose={() => setNotifOpen(false)} basePath="/creator" />
          </div>
          ...
          <div className="relative">
            ...
            >
              <div className="w-8 h-8 rounded-full bg-[#E8F5EE] flex items-center justify-center">
                <span style={{ fontFamily: "var(--font-heading)", fontSize: 13, fontWeight: 600, color: "#1A8A5A" }}>S</span>
              </div>
              <span className="hidden lg:inline" style={{ fontFamily: "var(--font-body)", fontSize: 14, fontWeight: 500, color: "#0D1F17" }}>@snehavibes</span>
            ...
            {profileOpen && (
              <>
                ...
                >
                  <Link to="/creator/account" className="flex items-center gap-2.5 px-4 py-2.5 hover:bg-[#F8FAF9] no-underline transition-colors" style={{ fontSize: 14, color: "#0D1F17" }}>
                    <User className="w-4 h-4 text-[#8FA69C]" /> My Profile
                  </Link>
                  <Link to="/creator/dashboard" className="flex items-center gap-2.5 px-4 py-2.5 hover:bg-[#F8FAF9] no-underline transition-colors" style={{ fontSize: 14, color: "#0D1F17" }}>
      ...
      <MobileDrawer open={mobileOpen} onClose={() => setMobileOpen(false)} role="creator" />
    </motion.nav>
  );
}